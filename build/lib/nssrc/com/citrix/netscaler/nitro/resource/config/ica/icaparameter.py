...
class icaparameter(base_resource) :
	...
	@property
	def l7latencyfrequency(self) :
		r"""Specify the time interval/period for which L7 Client Latency value is to be calculated. By default, L7 Client Latency is calculated for every packet. The default value is 0.<br/>Default value: 0<br/>Maximum length =  60.
		"""
		try :
			return self._l7latencyfrequency
		except Exception as e:
			raise e

	@l7latencyfrequency.setter
	def l7latencyfrequency(self, l7latencyfrequency) :
		r"""Specify the time interval/period for which L7 Client Latency value is to be calculated. By default, L7 Client Latency is calculated for every packet. The default value is 0.<br/>Default value: 0<br/>Maximum length =  60
		"""
		try :
			self._l7latencyfrequency = l7latencyfrequency
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.l7latencyfrequency = resource.l7latencyfrequency
