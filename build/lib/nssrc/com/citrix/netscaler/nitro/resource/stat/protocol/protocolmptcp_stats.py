...
class protocolmptcp_stats(base_resource) :
	...
	def __init__(self) :
		...
		self._mptcptotv1mpcapsession = 0
		self._mptcpv1mpcapsessionrate = 0
		self._mptcptotsfconn = 0
		self._mptcpsfconnrate = 0
		self._mptcpcurmpcapablesessions = 0
		self._mptcpcurv1mpcapablesessions = 0
		...
		self._mptcptotv1mpcapsyn = 0
		self._mptcpv1mpcapsynrate = 0
		...
		self._mptcperrv1datarecvdpriortokey = 0
		self._mptcperrv1datarecvdpriortokeyrate = 0
	...
	@property
	def mptcpv1mpcapsynrate(self) :
		r"""Rate (/s) counter for mptcptotv1mpcapsyn.
		"""
		try :
			return self._mptcpv1mpcapsynrate
		except Exception as e:
			raise e
	...
	@property
	def mptcptotv1mpcapsyn(self) :
		r"""MPTCP total Version1 MP_CAPABLE received.
		"""
		try :
			return self._mptcptotv1mpcapsyn
		except Exception as e:
			raise e
	...
	@property
	def mptcptotv1mpcapsession(self) :
		r"""MPTCP total V1 sessions created.
		"""
		try :
			return self._mptcptotv1mpcapsession
		except Exception as e:
			raise e
	...
	@property
	def mptcperrv1datarecvdpriortokey(self) :
		r"""MPTCP V1 data received prior to key.
		"""
		try :
			return self._mptcperrv1datarecvdpriortokey
		except Exception as e:
			raise e
	...
	@property
	def mptcpv1mpcapsessionrate(self) :
		r"""Rate (/s) counter for mptcptotv1mpcapsession.
		"""
		try :
			return self._mptcpv1mpcapsessionrate
		except Exception as e:
			raise e
	...
	@property
	def mptcperrv1datarecvdpriortokeyrate(self) :
		r"""Rate (/s) counter for mptcperrv1datarecvdpriortokey.
		"""
		try :
			return self._mptcperrv1datarecvdpriortokeyrate
		except Exception as e:
			raise e
	...
	@property
	def mptcpcurv1mpcapablesessions(self) :
		r"""The number of current V1 mptcp sessions.
		"""
		try :
			return self._mptcpcurv1mpcapablesessions
		except Exception as e:
			raise e
