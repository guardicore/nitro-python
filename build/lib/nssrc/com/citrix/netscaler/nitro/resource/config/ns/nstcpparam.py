...
class nstcpparam(base_resource) :
	...
	def __init__(self) :
		...
		self._mptcpsendsfresetoption = None
		self._mptcpfastcloseoption = None
		self._mptcpreliableaddaddr = None
		self._tcpfastopencookietimeout = None
		self._autosyncookietimeout = None
		self._tcpfintimeout = None
		self._compacttcpoptionnoop = None
		self._delinkclientserveronrst = None
		self._builtin = None
		self._feature = None
	...
	@property
	def mptcpsendsfresetoption(self) :
		r"""Allow MPTCP subflows to send TCP RST Reason (MP_TCPRST) Option while sending TCP RST.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._mptcpsendsfresetoption
		except Exception as e:
			raise e

	@mptcpsendsfresetoption.setter
	def mptcpsendsfresetoption(self, mptcpsendsfresetoption) :
		r"""Allow MPTCP subflows to send TCP RST Reason (MP_TCPRST) Option while sending TCP RST.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._mptcpsendsfresetoption = mptcpsendsfresetoption
		except Exception as e:
			raise e

	@property
	def mptcpfastcloseoption(self) :
		r"""Allow to select option ACK or RESET to force the closure of an MPTCP connection abruptly.<br/>Default value: ACK<br/>Possible values = ACK, RESET.
		"""
		try :
			return self._mptcpfastcloseoption
		except Exception as e:
			raise e

	@mptcpfastcloseoption.setter
	def mptcpfastcloseoption(self, mptcpfastcloseoption) :
		r"""Allow to select option ACK or RESET to force the closure of an MPTCP connection abruptly.<br/>Default value: ACK<br/>Possible values = ACK, RESET
		"""
		try :
			self._mptcpfastcloseoption = mptcpfastcloseoption
		except Exception as e:
			raise e

	@property
	def mptcpreliableaddaddr(self) :
		r"""If enabled, Citrix ADC retransmits MPTCP ADD-ADDR option if echo response is not received within the timeout interval. The retransmission is attempted only once.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._mptcpreliableaddaddr
		except Exception as e:
			raise e

	@mptcpreliableaddaddr.setter
	def mptcpreliableaddaddr(self, mptcpreliableaddaddr) :
		r"""If enabled, Citrix ADC retransmits MPTCP ADD-ADDR option if echo response is not received within the timeout interval. The retransmission is attempted only once.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._mptcpreliableaddaddr = mptcpreliableaddaddr
		except Exception as e:
			raise e
	...
	@property
	def tcpfintimeout(self) :
		r"""The amount of time in seconds, after which a TCP connnection in the TCP TIME-WAIT state is flushed.<br/>Default value: 40<br/>Minimum length =  10<br/>Maximum length =  240.
		"""
		try :
			return self._tcpfintimeout
		except Exception as e:
			raise e

	@tcpfintimeout.setter
	def tcpfintimeout(self, tcpfintimeout) :
		r"""The amount of time in seconds, after which a TCP connnection in the TCP TIME-WAIT state is flushed.<br/>Default value: 40<br/>Minimum length =  10<br/>Maximum length =  240
		"""
		try :
			self._tcpfintimeout = tcpfintimeout
		except Exception as e:
			raise e

	@property
	def compacttcpoptionnoop(self) :
		r"""If enabled, non-negotiated TCP options are removed from the received packet while proxying it. By default, non-negotiated TCP options would be replaced by NOPs in the proxied packets. This option is not applicable for Citrix ADC generated packets.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._compacttcpoptionnoop
		except Exception as e:
			raise e

	@compacttcpoptionnoop.setter
	def compacttcpoptionnoop(self, compacttcpoptionnoop) :
		r"""If enabled, non-negotiated TCP options are removed from the received packet while proxying it. By default, non-negotiated TCP options would be replaced by NOPs in the proxied packets. This option is not applicable for Citrix ADC generated packets.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._compacttcpoptionnoop = compacttcpoptionnoop
		except Exception as e:
			raise e

	@property
	def delinkclientserveronrst(self) :
		r"""If enabled, Delink client and server connection, when there is outstanding data to be sent to the other side.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._delinkclientserveronrst
		except Exception as e:
			raise e

	@delinkclientserveronrst.setter
	def delinkclientserveronrst(self, delinkclientserveronrst) :
		r"""If enabled, Delink client and server connection, when there is outstanding data to be sent to the other side.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._delinkclientserveronrst = delinkclientserveronrst
		except Exception as e:
			raise e
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.mptcpsendsfresetoption = resource.mptcpsendsfresetoption
		updateresource.mptcpfastcloseoption = resource.mptcpfastcloseoption
		updateresource.mptcpreliableaddaddr = resource.mptcpreliableaddaddr
		...
		updateresource.tcpfintimeout = resource.tcpfintimeout
		updateresource.compacttcpoptionnoop = resource.compacttcpoptionnoop
		updateresource.delinkclientserveronrst = resource.delinkclientserveronrst
	...
	class Mptcpreliableaddaddr:
		ENABLED = "ENABLED"
		DISABLED = "DISABLED"

	class Delinkclientserveronrst:
		ENABLED = "ENABLED"
		DISABLED = "DISABLED"

	class Mptcpsendsfresetoption:
		ENABLED = "ENABLED"
		DISABLED = "DISABLED"
