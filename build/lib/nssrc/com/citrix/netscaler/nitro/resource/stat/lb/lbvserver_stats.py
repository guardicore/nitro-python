...
class lbvserver_stats(base_resource) :
	...
	def __init__(self) :
		...
		self._totalh2requests = 0
		self._h2requestsrate = 0
		self._totalh2responses = 0
		self._h2responsesrate = 0
		...
		self._reqretrycount = 0
		self._reqretrycountexceeded = 0
		self._httpmaxhdrszpkts = 0
		self._httpmaxhdrfldlenpkts = 0
	...
	@property
	def reqretrycountexceeded(self) :
		r"""Number of times Maximum retry count threshold is exceeded and error returned to client.
		"""
		try :
			return self._reqretrycountexceeded
		except Exception as e:
			raise e
	...
	@property
	def totalh2responses(self) :
		r"""Number of Http2 responses received on this service or virtual server. (This applies to HTTP/SSL services and servers.).
		"""
		try :
			return self._totalh2responses
		except Exception as e:
			raise e

	@property
	def reqretrycount(self) :
		r"""Number of times request has been retried due to server failure.
		"""
		try :
			return self._reqretrycount
		except Exception as e:
			raise e
	...
	@property
	def h2requestsrate(self) :
		r"""Rate (/s) counter for totalh2requests.
		"""
		try :
			return self._h2requestsrate
		except Exception as e:
			raise e
	...
	@property
	def cpuusagepm(self) :
		r"""Vserver CPU usage in per-mille(parts per thousand).
		"""
		try :
			return self._cpuusagepm
		except Exception as e:
			raise e
	...
	@property
	def totalh2requests(self) :
		r"""Total number of Http2 requests received on this service or virtual server. (This applies to HTTP/SSL services and servers.).
		"""
		try :
			return self._totalh2requests
		except Exception as e:
			raise e
	...
	@property
	def h2responsesrate(self) :
		r"""Rate (/s) counter for totalh2responses.
		"""
		try :
			return self._h2responsesrate
		except Exception as e:
			raise e
	...
	@property
	def httpmaxhdrfldlenpkts(self) :
		r"""Number of HTTP requests exceeding max header field length.
		"""
		try :
			return self._httpmaxhdrfldlenpkts
		except Exception as e:
			raise e
	...
	@property
	def botpolicy(self) :
		r"""botpolicy that are bound to lbvserver.
		"""
		try :
			return self._botpolicy
		except Exception as e:
			raise e

	@botpolicy.setter
	def botpolicy(self, botpolicy) :
		r"""botpolicy that are bound to lbvserver.
		"""
		try :
			self._botpolicy = botpolicy
		except Exception as e:
			raise e
