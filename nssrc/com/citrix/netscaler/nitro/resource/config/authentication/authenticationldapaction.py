...
class authenticationldapaction(base_resource) :
	...
	def groupsearchfilter(self) :
		r"""String to be combined with the default LDAP group search string to form the search value.  For example, the group search filter ""vpnallowed=true"" when combined with the group identifier ""samaccount"" and the group name ""g1"" yields the LDAP search string ""(&(vpnallowed=true)(samaccount=g1)"". If nestedGroupExtraction is ENABLED, the filter is applied on the first level group search as well, otherwise first level groups (of which user is a direct member of) will be fetched without applying this filter. (Be sure to enclose the search string in two sets of double quotation marks; both sets are needed.).
		"""
		try :
	...
	@property
	def cloudattributes(self) :
		r"""The Citrix ADC uses the cloud attributes to extract additional attributes from LDAP servers required for Citrix Cloud operations.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._cloudattributes
		except Exception as e:
			raise e

	@cloudattributes.setter
	def cloudattributes(self, cloudattributes) :
		r"""The Citrix ADC uses the cloud attributes to extract additional attributes from LDAP servers required for Citrix Cloud operations.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED
		"""
		try :
			self._cloudattributes = cloudattributes
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.cloudattributes = resource.cloudattributes
		return addresource
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.cloudattributes = resource.cloudattributes
