...
class nshttpprofile(base_resource) :
	...
	@property
	def maxheaderfieldlen(self) :
		r"""Maximum header field length.<br/>Default value: 16384<br/>Minimum length =  2048<br/>Maximum length =  122880.
		"""
		try :
			return self._maxheaderfieldlen
		except Exception as e:
			raise e

	@maxheaderfieldlen.setter
	def maxheaderfieldlen(self, maxheaderfieldlen) :
		r"""Maximum header field length.<br/>Default value: 16384<br/>Minimum length =  2048<br/>Maximum length =  122880
		"""
		try :
			self._maxheaderfieldlen = maxheaderfieldlen
		except Exception as e:
			raise e
	...
	def filter_add_parameters(cls, resource) :
		...
		addresource.maxheaderfieldlen = resource.maxheaderfieldlen
	...
	def filter_update_parameters(cls, resource) :
		...
		updateresource.maxheaderfieldlen = resource.maxheaderfieldlen
