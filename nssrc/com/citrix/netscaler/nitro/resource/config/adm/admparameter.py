...
class admparameter(base_resource) :
	...
	@property
	def lowtouchonboard(self) :
		r"""ENABLED value indicates that this ADC can be on-boarded onto Citrix ADM Service using auto-onboarding process. Refer to [https://docs.citrix.com/en-us/citrix-application-delivery-management-service/service-connect-onboarding.html] for further details.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._lowtouchonboard
		except Exception as e:
			raise e
